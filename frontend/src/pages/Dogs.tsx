...
const mockDogs: Dog[] = [
  {
    id: 'dog1',
    name: 'Rex',
    breed: 'Norsk Elghund Grå',
    birth_date: '2019-05-15',
    color: '#FF6B6B',
    garmin_collar_id: 'DC50-12345',
    notes: 'Erfaren elghund med godt driv',
    is_active: true,
    stats: {
      total_hunts: 47,
      total_distance: 324.5,
      last_hunt: '2024-10-15',
    },
  },
  {
    id: 'dog2',
    ...
    color: '#4ECDC4',
    garmin_collar_id: 'DC50-12346',
    notes: 'Ung og ivrig, god på rådyr',
    is_active: true,
    stats: {
      total_hunts: 18,
  ...
  },
  {
    ...
    color: '#F7DC6F',
    notes: 'Pensjonert, brukes ved spesielle anledninger',
    is_active: false,
    stats: {
      total_hunts: 89,
      total_distance: 612.8,
      last_hunt: '2023-11-20',
    },
  },
];
